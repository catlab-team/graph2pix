...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--mv', action='store_true', help='if specified, takes input from multiple views')

        self.parser.add_argument('--smart_disc', action='store_true', help='smart discriminitor open!')
        self.parser.add_argument('--num_disc_images', type=int, default=0, help='smart discriminitor open!')
